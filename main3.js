var mainVersion='0.785';var theme="dark";var menuVis=false;var srchVis=false;function absolute(base,relative){var stack=base.split("/"),parts=relative.split("/");stack.pop();for(var i=0;i<parts.length;i++){if(parts[i]==".")continue;if(parts[i]=="..")stack.pop();else stack.push(parts[i]);}
return stack.join("/");}
...
if(transQ){path='http://www.shuxuele.com'+path;var newDiv=document.createElement("div");var tgtDiv=document.getElementById("content");document.body.insertBefore(newDiv,tgtDiv);var str='<div style="position: absolute; right: 50%; margin-right: 260px; top:120px; font:45px Arial; background-color: rgba(255, 220, 0, 0.5);  border-radius:5px; border: 1px solid red; "><a href="'+path+'" style="color:red; text-decoration: none;">ä¸­æ–‡</a></div>';newDiv.innerHTML=str;}}
...
document.write(s);}
function urlSttGet(){var stack=location.href.split("/");stack.pop();var url=stack.join("/");var urlStt="../";if(endsWith(url,"/mathsisfun"))urlStt="";if(endsWith(url,"mathsisfun.com"))urlStt="";return urlStt}
...
var sep=' &cir; '
s+='<div id="footMenu">';s+='<a href="'+urlStt+'search/search.php">Search</a>'+sep
